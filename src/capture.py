...
── LIVE MODE ─────────────────────────────────────────────────────────────────
  python src/capture.py live --out data/gesture.h5 --label hands_up
...
── BATCH MODE ─────────────────────────────────────────────────────────────────
  python src/capture.py batch --src recording.mp4 --out data/gesture_tpose.h5 --label t_pose
  python src/capture.py batch --src recording.mp4 --out data/out.npz --conf 0.6
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    B.add_argument("--out",        default="data/gesture.h5",
                   help="Output dataset path  (default: data/gesture.h5)")
